...
const settings=()=>({
    ...
    overlays: s.overlays.map((o,i)=>({...o, 
        ...
        x: num(`ov-x-${i}`),
        y: num(`ov-y-${i}`),
        scale_percent: num(`ov-scale-${i}`)||25,
